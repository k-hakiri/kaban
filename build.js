...
const routeConfig = {
    '/': {
        ...
        description: '山梨県甲府市のカバン修理専門店「波切カバン店」。ルイ・ヴィトン、グッチ、エルメス、コーチ等のブランドバッグ修理、キャスター交換、ファスナー修理、持ち手交換など、職人が丁寧にお直しします。山梨県全域からご来店いただいております。',
        keywords: 'カバン修理,山梨,甲府,ブランドバッグ修理,ルイ・ヴィトン 修理,グッチ 修理,シャネル,エルメス,コーチ,プラダ,セリーヌ,ロエベ,キャスター交換,バッグ修理,波切カバン店',
        ogTitle: '波切カバン店 - 職人の手による丁寧なカバン修理',
        ogDescription: '思い出の詰まった大切なカバン、職人の技術で蘇らせます。ヴィトンやグッチ等、ハイブランドの修理実績も豊富です。山梨県全域からご来店いただいております。',
        priority: '1.0',
    },
    '/pricing': {
        title: '修理メニュー・料金 | 波切カバン店',
        description: 'キャスター交換、ファスナー修理、持ち手交換、内張り張替えなど、波切カバン店の修理メニューと概算料金をご案内します。ルイ・ヴィトンやコーチなど、ブランドバッグの修理料金もご確認いただけます。',
        keywords: '修理料金,メニュー,ブランドバッグ 修理 料金,ルイ・ヴィトン 修理 料金,キャスター交換 料金,ファスナー修理,山梨 カバン修理,波切カバン店',
    ...
    '/repair-flow': {
        title: '修理の流れ | 波切カバン店',
        description: '波切カバン店でのカバン修理の流れをご紹介します。ルイ・ヴィトン等のブランドバッグからキャリーケースまで、甲府市・甲斐市など山梨県各地からのご依頼に丁寧に対応いたします。',
        keywords: '修理の流れ,見積もり無料,カバン修理 期間,ブランドバッグ 修理,山梨 鞄修理,甲府市 修理,波切カバン店',
    ...
    '/faq': {
        ...
        description: '山梨県でのカバン修理に関するよくあるご質問（FAQ）にお答えします。ルイ・ヴィトン、シャネル、エルメス等のハイブランド修理への対応や修理期間、見積もりについて詳しく解説します。',
        keywords: 'よくあるご質問,FAQ,ハイブランド修理,ルイ・ヴィトン 修理,エルメス 修理,山梨 カバン修理,甲府市 バッグ修理,波切カバン店',
        ogTitle: 'よくあるご質問 | 波切カバン店',
        ogDescription: 'カバン修理に関するよくあるご質問（FAQ）にお答えします。ハイブランドの修理対応について。',
        priority: '0.8',
        // 案A: FAQPage構造化データ
    ...
    '/voices': {
        title: 'お客様の声 | 波切カバン店',
        description: '甲府市・甲斐市など山梨県内各地から波切カバン店をご利用いただいたお客様からの声をご紹介します。キャスター交換やブランドバッグ修理など、確かな技術でご満足いただいた感想をご覧ください。',
        keywords: 'お客様の声,修理事例,クチコミ,評判,山梨 カバン修理,甲府 バッグ修理,波切カバン店',
    ...
    '/store-info': {
        title: '店舗情報 | 波切カバン店',
        description: '山梨県甲府市にある波切カバン店の店舗情報。甲府市・甲斐市・笛吹市など山梨県全域からお越しいただいております。営業時間、アクセス、駐車場のご案内はこちら。',
        keywords: '店舗情報,アクセス,駐車場,営業時間,甲府市 カバン修理,山梨 鞄修理,甲斐市,笛吹市,波切カバン店',
        ogTitle: '店舗情報 | 波切カバン店',
