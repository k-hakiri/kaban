...
const routeConfig = {
    '/': {
        ...
        description: '山梨県甲府市のカバン修理専門店「波切カバン店」。甲府市・甲斐市・笛吹市・南アルプス市など山梨県全域からご来店いただいております。キャスター交換、ファスナー修理、持ち手交換など、職人が丁寧にお直しします。',
        keywords: 'カバン修理,山梨,甲府,甲斐市,笛吹市,中央市,南アルプス市,韮崎市,山梨市,甲州市,キャスター交換,バッグ修理,財布修理,波切カバン店',
        ogTitle: '波切カバン店 - 職人の手による丁寧なカバン修理',
        ogDescription: '思い出の詰まった大切なカバン、職人の技術で蘇らせます。甲府市・甲斐市・笛吹市など山梨県全域からご来店いただいております。',
        priority: '1.0',
    },
    '/pricing': {
        title: '修理メニュー・料金 | 波切カバン店',
        description: 'キャスター交換、ファスナー修理、持ち手交換、内張り張替えなど、波切カバン店の修理メニューと概算料金をご案内します。甲府市・甲斐市・笛吹市など山梨県内各地域から修理のご相談を承っております。',
        keywords: '修理料金,メニュー,キャスター交換 料金,ファスナー修理 料金,内張り張替え,山梨 カバン修理,甲府 バッグ修理,波切カバン店',
    ...
    '/repair-flow': {
        title: '修理の流れ | 波切カバン店',
        description: '波切カバン店でのカバン修理の流れをご紹介します。甲府市・甲斐市・南アルプス市など山梨県各地からのご依頼に、お見積もりから修理完了まで丁寧に対応いたします。',
        keywords: '修理の流れ,見積もり無料,カバン修理 期間,依頼方法,山梨 鞄修理,甲府市 修理,波切カバン店',
    ...
    '/faq': {
        ...
        description: '山梨県でのカバン修理に関するよくあるご質問（FAQ）にお答えします。修理期間や無料見積もり、他店で断られたカバンの修理、ハイブランド対応についてなど、地域の皆様の疑問を解決します。',
        keywords: 'よくあるご質問,FAQ,修理期間,見積もり,ハイブランド修理,山梨 カバン修理,甲府市 バッグ修理,波切カバン店',
